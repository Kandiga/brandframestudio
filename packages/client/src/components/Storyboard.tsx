...
export const Storyboard: React.FC<StoryboardProps> = ({ script, frames, onSceneReorder }) => {
    ...
    <div className="bg-white dark:bg-[#1C2030] rounded-xl p-6 flex flex-col gap-6">
      ...
      <div className="border-b border-gray-200 dark:border-gray-700">
        <nav aria-label="Tabs" className="flex -mb-px">
          <a aria-current="page" className="w-1/2 py-4 px-1 text-center border-b-2 font-medium text-sm text-primary border-primary" href="#">Storyboard View</a>
          <a className="w-1/2 py-4 px-1 text-center border-b-2 font-medium text-sm text-gray-500 dark:text-gray-400 border-transparent hover:text-gray-700 dark:hover:text-gray-200 hover:border-gray-300 dark:hover:border-gray-600" href="#">Script View</a>
        </nav>
      </div>
